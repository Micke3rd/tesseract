...
namespace Tesseract.Interop
{
	internal class DllLoader
	{
		...
		internal static bool ForceLoadLibrary(string dllName)
		{
			...
			var newDllPath = Path.Combine(Directory.GetCurrentDirectory(), "x64", dllName);
			...
			var ret = LoadLibraryEx(newDllPath,IntPtr.Zero,0x00001000 | 0x00000100); // Careful of dependencies
			if (IntPtr.Zero == ret)
			{
